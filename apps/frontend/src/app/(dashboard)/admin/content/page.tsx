...
import { SubscriberManager } from "./_components/subscriber-manager";
    ...
    return (
        <div className="p-6 space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Manage your website&apos;s public content: Team, Socials, Subscribers and Inquiries.</p>
            </div>
            ...
            <Tabs defaultValue="team" className="space-y-4">
                <TabsList>
                    ...
                    <TabsTrigger value="subscribers">Waitlist</TabsTrigger>
